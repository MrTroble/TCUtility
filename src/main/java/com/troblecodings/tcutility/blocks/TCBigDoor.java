...
public class TCBigDoor extends TCCube {
    ...
    protected static final AxisAlignedBB SOUTH_L_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.5D,
            1.0D, 0.1875D);
    protected static final AxisAlignedBB NORTH_L_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.8125D, 1.5D,
            1.0D, 1.0D);
    protected static final AxisAlignedBB WEST_L_AABB = new AxisAlignedBB(0.8125D, 0.0D, 0.0D, 1.0D,
            1.0D, 1.5D);
    protected static final AxisAlignedBB EAST_L_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 0.1875D,
            1.0D, 1.5D);
    protected static final AxisAlignedBB SOUTH_R_AABB = new AxisAlignedBB(-0.5D, 0.0D, 0.0D, 1.0D,
            1.0D, 0.1875D);
    protected static final AxisAlignedBB NORTH_R_AABB = new AxisAlignedBB(-0.5D, 0.0D, 0.8125D,
            1.0D, 1.0D, 1.0D);
    protected static final AxisAlignedBB WEST_R_AABB = new AxisAlignedBB(0.8125D, 0.0D, -0.5D, 1.0D,
            1.0D, 1.0D);
